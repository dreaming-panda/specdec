...
class Transformer(nn.Module):
    ...
    def forward(self, idx: Tensor, input_pos: Optional[Tensor] = None, cache_pos: Optional[Tensor] = None, attention_mask: Optional[Tensor] = None) -> Tensor:
        ...
        mask = self.causal_mask[None, None, input_pos] if attention_mask is None else attention_mask
        
        if cache_pos is None:
            cache_pos = input_pos
        
        assert mask.shape == self.causal_mask[None, None, input_pos].shape, "attention mask shape misaligned"
